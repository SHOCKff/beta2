...
apicall(0,surahno);//Dfault langugae english(0)
...
document.getElementById("apply_cng").onclick=()=>{    //api call to get transalted array
 apicall(document.getElementById("dropdown").value,surahno)
 Animate(block);
}
Animate=(tell)=>{
